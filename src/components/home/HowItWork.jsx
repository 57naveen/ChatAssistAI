import { Bot, MessageSquare, ShoppingCart, MoveRight } from 'lucide-react'
...
const steps = [
  {
    ...
    label: 'Ask for Help',
    description: 'Describe your issue or question about the product you’ve purchased',
  },
  {
    icon: <Bot size={64} strokeWidth={1.5} />,
    label: 'Chatbot Responds',
    description: 'Our intelligent chatbot provides instant answers and support solutions',
  },
  {
    icon: <ShoppingCart size={64} strokeWidth={1.5} />,
    label: 'Personalized Suggestions',
    description: 'Get upgrade suggestions or product recommendations tailored to your needs',
  },
]
      ...
      <section className='relative overflow-hidden bg-gray-50'>
        <div className='py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12'>
          ...
          <div className='text-center mb-16'>
            <h2 className='font-bold text-xl uppercase mb-4 text-rose-400'>How it works</h2>
            <h3 className='font-bold text-3xl max-w-2xl mx-auto'>
              Get product support and smart suggestions in three simple steps
            </h3>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto relative mt-10'>
              {steps.map((step, idx) => (
  ...
  return (
    <div
      className='relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs
        border border-white/10 hover:border-rose-500 transition-colors group w-full'
    >
